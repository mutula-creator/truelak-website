    ...
    <>
      <div className="page-hero">
        <div className="container">
          <h1>About TrueLak</h1>
          <p>East Africa and UAE&apos;s trusted recruitment partner since day one</p>
        </div>
      </div>
        ...
        <div className="container">
          <div className={styles.mvGrid}>
            ...
            <div className={styles.mvCard} style={{ borderTop: '4px solid var(--crimson)' }}>
              <h3>🌟 Our Vision</h3>
              <p>To be East Africa and UAE&apos;s most trusted and impactful recruitment agency — empowering individuals to build meaningful careers and helping businesses build exceptional teams.</p>
            </div>
          </div>
        </div>
      </section>
