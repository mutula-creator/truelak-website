...
export async function sendCvApplicationEmail({ fullName, email, phone, jobCategory, jobTitle, message }) {
  await sendEmail({
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
        ...
        <div style="background:#f7f8fa;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e5e7eb;">
          ...
          <div style="margin-top:20px;padding:16px;background:#fff3cd;border-radius:6px;border-left:4px solid #C0192A;">
            <p style="margin:0;color:#111827;font-size:14px;">⚠️ A CV file was uploaded. Log in to the admin panel to download it.</p>
          </div>
